...
execute if score #is_silk_touch simplenergy.data matches 0 as @e[type=item, sort=nearest, tag=energyutils.selected] run function energyutils:v1.0.0/blocks/deepslate_silver_ore/destroy_normal
