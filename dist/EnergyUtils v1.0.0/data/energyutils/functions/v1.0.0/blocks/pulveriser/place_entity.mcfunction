...
execute if entity @s[tag=energyutils.north] run data modify entity @s Item.tag.itemio.ioconfig append value {Slot: 15b, mode: "output", allowed_side: {west: 1b}}
execute if entity @s[tag=energyutils.east] run data modify entity @s Item.tag.itemio.ioconfig append value {Slot: 15b, mode: "output", allowed_side: {north: 1b}}
...
function energyutils:v1.0.0/blocks/pulveriser/tick_gui
