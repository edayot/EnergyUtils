...
execute if data block ~ ~ ~ Items[{Slot: 16b}] unless data block ~ ~ ~ Items[{Slot: 16b}].tag.ctc{from: "airdox_:energyutils", id: "wireless_upgrade"} run function energyutils:v1.0.0/blocks/wireless_charger/drop_upgrade
...
execute if score @s energy.storage matches 120.. if entity @a[tag=energyutils.in_radius] run function energyutils:v1.0.0/blocks/wireless_charger/give_energy
