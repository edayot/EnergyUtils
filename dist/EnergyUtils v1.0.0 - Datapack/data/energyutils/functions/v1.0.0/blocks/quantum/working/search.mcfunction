...
execute if entity @e[type=glow_item_frame, tag=energyutils.quantum.same_channel, tag=energyutils.quantum.output] run function energyutils:v1.0.0/blocks/quantum/working/repart


#Item transport
execute as @e[tag=energyutils.quantum.same_channel, tag=energyutils.quantum.output] at @s align xyz positioned ~0.5 ~0.5 ~0.5 run function energyutils:v1.0.0/blocks/quantum/working/items/generate_destination

execute as @e[tag=energyutils.quantum.same_channel, tag=energyutils.quantum.input] at @s align xyz positioned ~0.5 ~0.5 ~0.5 run function energyutils:v1.0.0/blocks/quantum/working/items/make_transfer
