...
execute if entity @s[tag=energyutils.quantum.input] run function energyutils:v1.0.0/blocks/quantum/gui/update_name_input
execute if entity @s[tag=energyutils.quantum.output] run function energyutils:v1.0.0/blocks/quantum/gui/update_name_output
...
execute if entity @s[tag=energyutils.quantum.input] run item replace block ~ ~ ~ container.3 with stone{CustomModelData: 1430100, energyutils: {quantum_gui: 1b, gui: 1b, quantum_change_mode: 1b}, display: {Name: '[{"text":"Mode : ","color":"gray","italic":false},{"text":"Input","color":"green","italic":false}]', Lore: ['{"text":"Click to change mode","color":"white","italic":false}']}}
execute if entity @s[tag=energyutils.quantum.output] run item replace block ~ ~ ~ container.3 with stone{CustomModelData: 1430100, energyutils: {quantum_gui: 1b, gui: 1b, quantum_change_mode: 1b}, display: {Name: '[{"text":"Mode : ","color":"gray","italic":false},{"text":"Output","color":"red","italic":false}]', Lore: ['{"text":"Click to change mode","color":"white","italic":false}']}}
...
function energyutils:v1.0.0/blocks/quantum/gui/display_channel
