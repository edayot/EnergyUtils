summon minecraft:marker ~3 ~ ~-1 {Tags: ["energyutils.auto_crafter_slot", "energyutils.summoned", "energyutils.auto_crafter_slot.0"], data: {itemio: {ioconfig: [{Slot: 2b, allowed_side: {top: 1b, north: 1b, south: 1b, east: 1b, west: 1b, bottom: 1b}}]}}}
...
summon minecraft:marker ~3 ~ ~1 {Tags: ["energyutils.auto_crafter_slot", "energyutils.summoned", "energyutils.auto_crafter_slot.2"], data: {itemio: {ioconfig: [{Slot: 4b, allowed_side: {top: 1b, north: 1b, south: 1b, east: 1b, west: 1b, bottom: 1b}}]}}}



summon minecraft:marker ~2 ~ ~-1 {Tags: ["energyutils.auto_crafter_slot", "energyutils.summoned", "energyutils.auto_crafter_slot.3"], data: {itemio: {ioconfig: [{Slot: 11b, allowed_side: {top: 1b, north: 1b, south: 1b, east: 1b, west: 1b, bottom: 1b}}]}}}

summon minecraft:glow_item_frame ~2 ~ ~ {Silent: 1b, Facing: 1b, ItemRotation: 2b, Invulnerable: 1b, Invisible: 1b, Fixed: 1b, Tags: ["energyutils.auto_crafter_slot", "energyutils.summoned", "energyutils.auto_crafter_slot.4"], Item: {id: "minecraft:beehive", Count: 1b, tag: {CustomModelData: 1430123, itemio: {ioconfig: [{Slot: 12b, allowed_side: {top: 1b, north: 1b, south: 1b, east: 1b, west: 1b, bottom: 1b}}]}}}}

summon minecraft:marker ~2 ~ ~1 {Tags: ["energyutils.auto_crafter_slot", "energyutils.summoned", "energyutils.auto_crafter_slot.5"], data: {itemio: {ioconfig: [{Slot: 13b, allowed_side: {top: 1b, north: 1b, south: 1b, east: 1b, west: 1b, bottom: 1b}}]}}}
...
summon armor_stand ~ ~ ~ {Rotation: [90.0f, 0.0f], Tags: ["energyutils.summoned"], HasVisualFire: 1b, Invisible: 1b, Marker: 1b, NoGravity: 1b, ArmorItems: [{}, {}, {}, {id: "minecraft:beehive", Count: 1b, tag: {CustomModelData: 1430122}}]}
...
execute as @e[type=armor_stand, tag=energyutils.summoned] at @s run function energyutils:v1.0.0/blocks/auto_crafter_core/place_entity

scoreboard players add #auto_crafter_id energyutils.math 1
execute as @e[tag=energyutils.summoned, distance=..4] run function energyutils:v1.0.0/blocks/auto_crafter_core/id_system
