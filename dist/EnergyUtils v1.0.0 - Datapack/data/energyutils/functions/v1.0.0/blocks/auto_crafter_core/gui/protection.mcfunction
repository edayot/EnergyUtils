...
execute unless data storage energyutils:main temp.GuiItems[{Slot: 0b}].tag.energyutils.auto_crafter_gui run function energyutils:v1.0.0/blocks/auto_crafter_core/gui/switch_config
...
execute if data storage energyutils:main temp.Items[0] run function energyutils:v1.0.0/blocks/auto_crafter_core/gui/try_fill
