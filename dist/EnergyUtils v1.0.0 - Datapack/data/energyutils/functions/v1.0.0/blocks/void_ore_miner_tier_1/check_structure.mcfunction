...
execute if score #good_structure energyutils.math matches 1 positioned ~-1 ~-5 ~ unless entity @e[type=minecraft:glow_item_frame, tag=energyutils.structure_panel, distance=..0.5] run scoreboard players set #good_structure energyutils.math 0
execute if score #good_structure energyutils.math matches 1 positioned ~-1 ~-5 ~1 unless entity @e[type=minecraft:glow_item_frame, tag=energyutils.structure_panel, distance=..0.5] run scoreboard players set #good_structure energyutils.math 0

execute if score #good_structure energyutils.math matches 1 positioned ~ ~-5 ~-1 unless entity @e[type=minecraft:glow_item_frame, tag=energyutils.structure_panel, distance=..0.5] run scoreboard players set #good_structure energyutils.math 0
execute if score #good_structure energyutils.math matches 1 positioned ~ ~-5 ~ unless entity @e[type=minecraft:glow_item_frame, tag=energyutils.laser_core, distance=..0.5] run scoreboard players set #good_structure energyutils.math 0
execute if score #good_structure energyutils.math matches 1 positioned ~ ~-5 ~1 unless entity @e[type=minecraft:glow_item_frame, tag=energyutils.structure_panel, distance=..0.5] run scoreboard players set #good_structure energyutils.math 0
...
execute if score #good_structure energyutils.math matches 1 positioned ~2 ~-5 ~ unless entity @e[type=minecraft:glow_item_frame, tag=energyutils.structure_frame_tier_1, distance=..0.5] run scoreboard players set #good_structure energyutils.math 0
execute if score #good_structure energyutils.math matches 1 positioned ~2 ~-5 ~1 unless entity @e[type=minecraft:glow_item_frame, tag=energyutils.structure_frame_tier_1, distance=..0.5] run scoreboard players set #good_structure energyutils.math 0
...
execute if score #good_structure energyutils.math matches 1 positioned ~ ~-5 ~2 unless entity @e[type=minecraft:glow_item_frame, tag=energyutils.structure_frame_tier_1, distance=..0.5] run scoreboard players set #good_structure energyutils.math 0
execute if score #good_structure energyutils.math matches 1 positioned ~1 ~-5 ~2 unless entity @e[type=minecraft:glow_item_frame, tag=energyutils.structure_frame_tier_1, distance=..0.5] run scoreboard players set #good_structure energyutils.math 0
