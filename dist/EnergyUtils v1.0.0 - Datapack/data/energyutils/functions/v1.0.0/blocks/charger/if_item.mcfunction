execute if score @s energy.storage matches 1.. run function energyutils:v1.0.0/blocks/charger/test_charge
...
function energyutils:v1.0.0/blocks/charger/gui/display_charged_item
