...
execute unless data storage energyutils:main temp.GuiItems[{Slot: 8b}].tag.energyutils.pulveriser_gui run function energyutils:v1.0.0/blocks/pulveriser/gui/auto_expulse
