...
execute if score #if_item energyutils.math matches 1 if score #if_ctc energyutils.math matches 0 run function energyutils:v1.0.0/items/filter/id_filter
execute if score #if_item energyutils.math matches 1 if score #if_ctc energyutils.math matches 1 run function energyutils:v1.0.0/items/filter/ctc_filter
