...
execute as @e[type=glow_item_frame,tag=energyutils.quantum.same_channel,tag=energyutils.quantum.output] run function energyutils:impl/blocks/quantum/working/repart_output

execute if score #storage energyutils.math matches 1.. run function energyutils:impl/blocks/quantum/working/repart_input