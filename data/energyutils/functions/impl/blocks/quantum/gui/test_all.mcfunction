...
function energyutils:impl/blocks/quantum/gui/test_change_mode
function energyutils:impl/blocks/quantum/gui/test_channel_down
function energyutils:impl/blocks/quantum/gui/test_channel_up
function energyutils:impl/blocks/quantum/gui/test_empty
function energyutils:impl/blocks/quantum/gui/test_number
function energyutils:impl/blocks/quantum/gui/test_reset