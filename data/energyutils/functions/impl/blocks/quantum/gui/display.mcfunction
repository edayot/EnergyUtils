...
execute if entity @s[tag=energyutils.quantum.input] run function energyutils:impl/blocks/quantum/gui/update_name_input
execute if entity @s[tag=energyutils.quantum.output] run function energyutils:impl/blocks/quantum/gui/update_name_output
...
function energyutils:impl/blocks/quantum/gui/display_channel
