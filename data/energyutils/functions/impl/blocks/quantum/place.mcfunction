...
execute if score @s energyutils.quantum_owner matches 0 run function energyutils:impl/blocks/quantum/update_owner
...
function energyutils:impl/blocks/quantum/gui/display
