...
execute if score #config energyutils.math matches 0 if score #count_nb energyutils.math matches 0 run function energyutils:impl/blocks/auto_crafter_core/gui/update_config
