...
execute as @e[type=armor_stand,tag=energyutils.summoned] at @s run function energyutils:impl/blocks/auto_crafter_core/place_entity

scoreboard players add #auto_crafter_id energyutils.math 1
execute as @e[tag=energyutils.summoned,distance=..4] run function energyutils:impl/blocks/auto_crafter_core/id_system