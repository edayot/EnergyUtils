...
execute if data storage energyutils:main temp.Items[0] run function energyutils:impl/blocks/pulveriser/gui/drop
...
execute unless data storage energyutils:main temp.GuiItems[{Slot:8b}].tag.energyutils.pulveriser_gui run function energyutils:impl/blocks/pulveriser/gui/auto_expulse
