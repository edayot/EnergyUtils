...
execute if score #bool_!same_item_1 energyutils.math matches 0 if score #bool_!same_item_2 energyutils.math matches 0 run function energyutils:impl/blocks/pulveriser/working/stop/normal
