...
execute if score #energy energyutils.math matches 10.. unless predicate energyutils:sneaking anchored eyes positioned ~ ~1.5 ~ run function energyutils:impl/items/decapitator/raycast/raycast
