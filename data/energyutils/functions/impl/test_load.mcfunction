...
execute if score #energyutils.simplenergy load.status matches 1 if score #energyutils.itemio load.status matches 1 if score #energyutils.block_utils load.status matches 1 if score #energyutils.smithed.crafter load.status matches 1 run function energyutils:impl/load
