...
scoreboard objectives add energyutils.teleporter.page dummy
...
schedule function energyutils:impl/20tick 3t replace
schedule function energyutils:impl/50tick 4t replace

schedule function energyutils:impl/200tick 5t replace

tag AirDox_ add convention.debug
execute as @a[tag=convention.debug] run function energyutils:impl/print_version
