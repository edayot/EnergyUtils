...
function energyutils:utils/update_lore/generate
...
execute if data storage energy:temp list[0].tag.ctc{id:"decapitator"} run function energyutils:utils/update_lore/decapitator
