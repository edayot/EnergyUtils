...
execute if score #valid energyutils.math matches 9 if data storage energyutils:main temp.ItemAutoCrafter[{Slot: 16b}] run function energyutils:blocks/auto_crafter_core/sup_craft/test_craft
execute if score #valid energyutils.math matches 9 if score #if_item energyutils.math matches 0 run function energyutils:blocks/auto_crafter_core/make_craft
