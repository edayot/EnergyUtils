...
setblock ~ ~ ~ minecraft:barrel{CustomName: '{"translate":"energyutils.wireless_charger.gui","font":"energyutils:gui","color":"white","with":[{"translate":"color":"#3F3F3F","font":"minecraft:default"}]}'}
