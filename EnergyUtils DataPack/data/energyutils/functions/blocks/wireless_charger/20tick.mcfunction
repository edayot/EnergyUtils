...
execute if data block ~ ~ ~ Items[{Slot:16b}] unless data block ~ ~ ~ Items[{Slot:16b}].tag.ctc{from:"airdox_:energyutils",id:"wireless_upgrade"} run function energyutils:blocks/wireless_charger/drop_upgrade 
