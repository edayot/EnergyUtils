...
execute if entity @s[tag=energyutils.quantum.input] run function energyutils:blocks/quantum/gui/update_name_input
execute if entity @s[tag=energyutils.quantum.output] run function energyutils:blocks/quantum/gui/update_name_output
...
function energyutils:blocks/quantum/gui/display_channel
