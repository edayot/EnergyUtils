...
execute if score @e[type=glow_item_frame,tag=energyutils.summoned,limit=1] energyutils.quantum_owner matches 0 run function energyutils:blocks/quantum/update_owner

execute as @e[type=glow_item_frame,tag=energyutils.summoned,limit=1] at @s run function energyutils:blocks/quantum/gui/display
