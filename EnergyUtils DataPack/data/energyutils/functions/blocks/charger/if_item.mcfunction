execute if score @s energy.storage matches 1.. run function energyutils:blocks/charger/test_charge
...
function energyutils:blocks/charger/gui/display_charged_item