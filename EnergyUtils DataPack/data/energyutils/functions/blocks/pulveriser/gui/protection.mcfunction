...
execute unless data storage energyutils:main temp.GuiItems[{Slot:8b}].tag.energyutils.pulveriser_gui run item replace block ~ ~ ~ container.8 with stone{CustomModelData:1430100,energyutils:{gui:1b,pulveriser_gui:1b},display:{Name:'{"text":""}'}}
