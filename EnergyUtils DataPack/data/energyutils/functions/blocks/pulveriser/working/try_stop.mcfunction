...
execute if score #count_all_1 energyutils.math matches ..64 if score #count_all_2 energyutils.math matches ..64 run function energyutils:blocks/pulveriser/working/stop/if_not_too_much
