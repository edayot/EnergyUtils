...
execute as @e[type=minecraft:glow_item_frame,tag=simpledrawer.drawer.item,distance=..1] if score @s simpledrawer.id = #test_id simpledrawer.math run function energyutils:blocks/pulveriser/auto_expulse/simpledrawer/north/transport
