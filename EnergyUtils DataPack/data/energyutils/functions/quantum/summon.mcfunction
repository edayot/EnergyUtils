summon item ~ ~ ~ {Tags:["EU_summoned"],Age:1,PickupDelay:0,Item:{id:"minecraft:furnace",Count:1b,tag:{CustomModelData:1430120,EF_kJ:0,EU_Quantum:1b,display:{Name:'{"text":"Quantum Transporter","italic":false}'},BlockEntityTag:{Lock:"EU_QuantumPlacer"}}}}
