...
item replace block ~ ~ ~ container.9 with stone{CustomModelData:1430100,energyutils:{quantum_gui:1b,quantum_number:1b},display:{Name:'{"text":""}'}}
item replace block ~ ~ ~ container.10 with stone{CustomModelData:1430100,energyutils:{quantum_gui:1b,quantum_number:1b},display:{Name:'{"text":""}'}}
