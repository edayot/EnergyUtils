summon item ~ ~ ~ {Tags:["EU_summoned"],Age:1,PickupDelay:0,Item:{id:"minecraft:furnace",Count:1b,tag:{EF_kJ:0,EU_ChunkLoader:1b,display:{Name:'{"text":"ChunkLoader","italic":false}'},BlockEntityTag:{Lock:"EU_ChunkLoaderPlacer"}}}}
