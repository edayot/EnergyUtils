...
item modify entity @e[tag=energyutils.GetPos,type=minecraft:chest_minecart] container.0 energyutils:chunkloader/get_pos
...
execute at @e[type=marker,tag=energyutils.Placer] run function energyutils:chunkloader/place/place
