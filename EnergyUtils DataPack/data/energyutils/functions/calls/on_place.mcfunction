#ChunkLoader
execute if data storage smithed.custom_block:main {blockApi:{id:"energyutils:chunkloader"}} run function energyutils:blocks/chunkloader/place
#Quantum Input
execute if data storage smithed.custom_block:main {blockApi:{id:"energyutils:quantum_input"}} run function energyutils:blocks/quantum/place_input
#Quantum Output
