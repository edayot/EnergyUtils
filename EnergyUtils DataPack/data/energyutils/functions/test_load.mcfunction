...
execute unless score SimplEnergy load.status matches 1094 run tellraw @a [{"translate":"energyutils.tellraw_prefix","color":"dark_red"},{"text":"Error Loading EnergyUtils, SimplEnergy v1.9.2 is required.","color":"red"}]
